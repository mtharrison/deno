...
TEST(LibDenoTest, InitializesCorrectly) {
  ...
  Deno* d = deno_new(deno_config{0, snapshot, empty, nullptr, nullptr, nullptr});
...
TEST(LibDenoTest, Snapshotter) {
  Deno* d1 = deno_new(deno_config{1, empty_snapshot, empty, nullptr, nullptr, nullptr});
  ...
  Deno* d2 = deno_new(deno_config{0, test_snapshot, empty, nullptr, nullptr, nullptr});
...
TEST(LibDenoTest, LastException) {
  Deno* d = deno_new(deno_config{0, empty_snapshot, empty, nullptr, nullptr, nullptr});
  EXPECT_EQ(deno_last_exception(d), nullptr);
  deno_execute(d, nullptr, "a.js", "\n\nthrow Error('boo');\n\n");
...
TEST(LibDenoTest, Shared) {
  ...
  Deno* d = deno_new(deno_config{0, snapshot, shared, nullptr, nullptr, nullptr});
...
TEST(LibDenoTest, SharedAtomics) {
  ...
  Deno* d = deno_new(deno_config{0, empty_snapshot, shared, nullptr, nullptr, nullptr});
  deno_execute(d, nullptr, "a.js",
